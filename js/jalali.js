/* ------------------------------------------------------------------
 * jalali.js — تبدیل دقیق تاریخ شمسی (جلالی) ↔ میلادی
 * الگوریتم بر پایه jalaali-js (محاسبه ریاضی، بدون نیاز به اینترنت)
 * ------------------------------------------------------------------ */
(function () {
  'use strict';
  ...
  if (typeof window !== 'undefined') window.Jalali = Jalali;
})();
